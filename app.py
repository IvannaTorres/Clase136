...
def show_entry():
    day_entry_list = pd.read_csv("/content/Clase136/static/assets/data_files/data_entry.csv")
...
def save_entry():
    ...
    with open("/content/Clase136/static/assets/data_files/data_entry.csv", "a") as f:
        f.write(entry)
