...
train_data = pd.read_csv("/content/Clase136/static/assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("/content/Clase136/static/assets/model_files/Tweet_Emotion.h5")
